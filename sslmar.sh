...
~/.acme.sh/acme.sh --installcert -d $domain --key-file /var/lib/marzban/certs/key.pem --fullchain-file /var/lib/marzban/certs/fullchain.pem
...
wget -q -O /var/lib/marzban/xray_config.json "https://raw.githubusercontent.com/Agunxzzz/MarXray/main/xray_config.json"
docker compose up -d
clear 
